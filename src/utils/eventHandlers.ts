...
import { closeNotifications, makeNotification, Notification } from './notifications'
...
let pluginsLoadingNotification: Notification | null = null; let pluginsToLoad = 0; let pluginsLoaded = 0
