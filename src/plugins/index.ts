...
async function ensurePluginExtras(): Promise<void> {
	...
	if (dwc) {
		...
		dwc.Components = dwcComponentsMod.default;
	}
}
...
function exposeGlobalAPI() {
	window.DWC = {
		...
		// DWC + Vuetify component maps used by external plugin builds. Both maps are
		// populated lazily on first external-plugin load by ensurePluginExtras() - the
		// core Vuetify set is seeded here so plugins can use them even before the lazy
		// load completes
		Components: {},
