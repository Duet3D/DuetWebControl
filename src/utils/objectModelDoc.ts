...
// hover provider (the file editor dialog) and the Object Model browser plugin
...
function loadDocs(): Promise<DocMap> {
	...
	if (pending === null) {
		pending = import(/* webpackChunkName: "documentation" */ "@duet3d/objectmodel/documentation.json")
			.then((module) => {
