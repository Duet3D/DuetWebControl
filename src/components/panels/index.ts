...
import SettingsHideMenuItemsPanel from "./SettingsHideMenuItemsPanel.vue";
...
import SettingsToolGroupingPanel from "./SettingsToolGroupingPanel.vue";
...
Vue.component("settings-hide-menu-items-panel", SettingsHideMenuItemsPanel);
...
Vue.component("settings-behaviour-panel", SettingsBehaviourPanel);
Vue.component("settings-tool-grouping-panel", SettingsToolGroupingPanel);
